...
const App = () => {
  ...
  const [data, setData] = useState(location.state?.menuData || {});
            ...
            {filteredData?.map((item) => (
              ...
              >
                <div className="p-4">
                  ...
                  <div className="h-48 bg-transparent rounded-lg mb-3 flex items-center justify-center">
